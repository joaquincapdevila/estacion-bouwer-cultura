...
export default function Noticias() {
  ...
  return (
    <main className="min-h-screen grid grid-cols-2 gap-12 max-w-7xl pt-24 m-auto overflow-hidden">
      <section className="max-h-screen col-span-2 lg:col-span-1 bg-red-200 rounded-lg shadow-lg ">
        {noticiaMasNueva && <NoticiaPrimaria noticia={noticiaMasNueva} />}
      </section>
      <section className="max-h-screen lg:overflow-y-auto col-span-2 lg:col-span-1 bg-red-200 rounded-lg shadow-lg ">
