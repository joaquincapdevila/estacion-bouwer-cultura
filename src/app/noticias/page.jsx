...
export default function Noticias() {
  ...
  return (
    <main className="min-h-screen grid grid-cols-2 gap-12 max-w-7xl pt-20 m-auto overflow-hidden">
      ...
      <section className="max-h-screen lg:overflow-y-auto col-span-2 lg:col-span-1 bg-gumbo-200 rounded-lg shadow-lg no-scrollbar">
