        ...
        <div className="w-500 h-400 object-cover text-white">
          ...
          <div className="py-2">
            ...
            <p className="mb-2">
              ...
              por nuestra diversidad, creatividad y compromiso con la identidad
              local. Buscamos fortalecer la cohesión social a través del arte y
              la cultura, contribuyendo al desarrollo integral de nuestra
              comunidad.
            </p>
          </div>
        </div>
